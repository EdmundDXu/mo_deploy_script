...
class NotebookTest(unittest.TestCase):
    ...
    def test_notebook(self):
        driver = self.driver
        driver.get("http://www.momodel.cn:8899/")
        print driver.title
        print driver
        driver.find_element_by_id("Header-login").click()
        driver.find_element_by_id("username").clear()
        driver.find_element_by_id("username").send_keys("edmund")
        driver.find_element_by_id("password").clear()
        driver.find_element_by_id("password").send_keys("redhat")
        driver.find_element_by_xpath(u"(.//*[normalize-space(text()) and normalize-space(.)='密码'])[1]/following::button[1]").click()
